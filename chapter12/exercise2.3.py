...
def dictionary_anagrams(t, n):
    """
    Take a list of word and return a dictionary composed in this way:
    { key = 'tuples o letters of size n' : [list of all the words composed by the letter's key present in the list t]
    :param t: list of words
    :param n: lenght of key
    :return: dictionary
    """
    d = dict()
    for elem in t:
...
def get_sortet_list(d):
    """
    Get a dictionary and return a list of value ordered based on its lenght
